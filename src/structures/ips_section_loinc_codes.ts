...
const FUNCTIONAL_STATUS_SNOMED_CODES: Record<string, string> = {
...
const FUNCTIONAL_STATUS_ASSESSMENT_LOINC_CODES: Record<string, string> = {
...
const ADVANCED_DIRECTIVE_CATEGORY_CODES = {
